...
async function main() {
  ...
  const prompt1 = `You are a classification tool and your primary purpose is to classify based on the issue title & issue description. 
  Issue title:${issueTitle}. Issue description: ${issueBody}. Output label must be one of the entries in this array: ${categoryArray}. 
  Refer to the following examples to determine the response. If the issue's title or body contains paportal, it should be labelled as paportal. 
  If it contains pcf, label issue as pcf. If the issue can't be classified, label it as unknown.`;
